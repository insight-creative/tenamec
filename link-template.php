...
function get_the_post_navigation( $args = array() ) {
	$args = wp_parse_args(
		$args,
		array(
			'prev_text'          => '<div class="postNavLinkWrapper"><span class="smallHeading fontLight"> Previous Post</span> <br> %title </div>',
			'next_text'          => '<div class="postNavLinkWrapper"><span class="smallHeading fontLight"> Next Post</span> <br> %title </div>',
			'in_same_term'       => false,
			'excluded_terms'     => '',
			'taxonomy'           => 'category',
